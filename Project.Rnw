...
Finally, we want to test our model for forecasting. For this purpose, we imagine ourselves standing in the end of December 2015 and make a h=\Sexpr{which(Factors[,1]=="2016-09-30")-which(Factors[,1]=="2015-12-30")-1}-step ahead forecast until the end of the third quarter of 2016 which is depicted in figure~\ref{fig:hstepFcast}
%
\begin{figure}[h]
\begin{center}
